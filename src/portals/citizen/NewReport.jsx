...
// These categories should ideally come from /api/categories — replace array with API fetch
const CATEGORIES = [
  'Illegal Dumping',
  'Missed Pickup',
  'Overflowing Bin',
...
export default function NewReport() {
  ...
  function handleFiles(e) {
    ...
    setPhotos((p) => [...p, ...previews].slice(0, 4))
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      throw new Error('Report submission API not connected yet.')
    } catch (err) {
  ...
  return (
    <div className="p-6 flex flex-col gap-6 max-w-2xl">
      <PageHeader
        ...
        subtitle="Describe the waste issue so collectors can respond quickly"
      />
      ...
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
        ...
        <Card className="p-5 flex flex-col gap-5">
          ...
          <TextareaField
            label="Description *"
            id="description"
            placeholder="Describe the issue in detail — type of waste, approximate quantity, any safety concerns…"
